...
class GL_Window:
    ...
    def plotPoints(self):
        ...
        gl.glColor3f(1.0, 0.0, 1.0) # this funtion doesnt have to be in MainLoop displayh function
        gl.glLineWidth(10.0) # this funtion doesnt have to be in MainLoop displayh function
